            ...
            {subscriptionPlans.map((plan, idx) => {
              ...
              return (
                  ...
                  >
                    ...
                    {plan.popular && (
                      <div className={`absolute top-0 right-0 rounded-bl-xl text-[10px] font-black px-3 py-1 uppercase tracking-wider shadow-sm z-20 ${tierType === 'ULTRA' ? 'bg-yellow-400 text-black' : 'bg-cyan-500 text-white'}`}>
                        🔥 Most Popular
                      </div>
                    )}
                    ...
                    <button
                      ...
                      className={`w-full py-2.5 px-4 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all relative z-10 ${
                        tierType === 'ULTRA'
