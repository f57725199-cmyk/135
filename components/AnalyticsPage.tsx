...
import { User, MCQResult, PerformanceTag } from '../types';
import { BarChart, Clock, Calendar, BookOpen, TrendingUp, AlertTriangle, CheckCircle, XCircle } from 'lucide-react';
...
export const AnalyticsPage: React.FC<Props> = ({ user, onBack }) => {
